...
class eventosWebEstatica
{
    //Se declaran auxiliarIdlas variables para los nombres de los elementos  
    private bloqueMenuId: string = "";
    private bloqueAuxiliarId: string = "";
    private bloqueContenidoId: string = "";
        
    private numero01: number;
    
    private bloqueMenuVisibilidad: boolean;
    private bloqueAuxiliarVisibilidad: boolean;
    
    //Se declara la variable de salida del proceso    
    private exito: boolean;
    
    public BotonClicEfecto (Afectado: number, bloqueMenuId: string, bloqueAuxiliarId: string, bloqueContenidoId: string): boolean
    {
        ...
        {
            if (this.numero01 == 1) /*Cambiar estado de 1*/
            {
            ...
            if (this.numero01 == 2) /*Cambiar estado de 2*/
            {
